...
(() => {
  ...
  const SHEET_URL =
    "https://script.google.com/macros/s/AKfycbwjIbqxoYq9F6oLJVN8vqQtYf6z9YpnjFjyF00xYCneGB7gUzVHVRayiT29amA0xn4tfQ/exec";
  ...
  function initFormSubmit() {
    ...
    on(form, "submit", async function (e) {
      ...
      try {
        ...
        const res = await fetch("https://mustaqil-ayol-backend.asosit.uz/api/dataflow2", {
          method: "POST",
          body: apiFD,
        });
        if (!res.ok) {
